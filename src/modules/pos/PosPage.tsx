    ...
    try {
      ...
      const { data: nuevaFactura, error: facErr } = await supabase
        ...
        .insert({
          ...
          iva,
          total: tot,
          subtotal_0: ivaRate === 0 ? sub : 0,
          subtotal_12: Math.abs(ivaRate - 0.12) < 0.001 ? sub : 0,
          subtotal_15: ivaRate === 0 || Math.abs(ivaRate - 0.12) < 0.001 ? 0 : sub,
          iva_12: Math.abs(ivaRate - 0.12) < 0.001 ? iva : 0,
          iva_15: ivaRate === 0 || Math.abs(ivaRate - 0.12) < 0.001 ? 0 : iva,
          estado: 'Autorizada',
          origen: 'POS',
          tipo_doc: tipoDoc,
