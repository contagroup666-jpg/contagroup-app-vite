...
const VACIO = { nombre: '', ruc: '', moneda: 'USD', regimen: 'General', estado: 'Activa', iva_porcentaje: '15' }
...
export default function EmpresasTab() {
  ...
  function abrirEditar(e: Empresa) {
    ...
    setForm({
      ...
      estado: e.estado,
      iva_porcentaje: String(e.iva_porcentaje ?? 15),
    })
    setErrorForm(null)
    setMostrarForm(true)
  }
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg bg-white/5 border border-white/10 px-3 py-2 text-sm text-white outline-none focus:border-[var(--color-blue-5)]"
                  />
                  <p className="text-[10px] text-white/30 mt-1">Tarifa general vigente en Ecuador: 15%. Ajusta libremente si esta empresa opera con otra tarifa (0%, otro régimen, otro país, etc.).</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2">
                <div>
